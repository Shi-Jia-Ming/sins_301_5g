...
<template>
  <div>
    ...
    <div class="item">
      ...
      <div class="content">
        ...
        <div class="list">
          ...
          <div class="val">{{ userInfo && userInfo.height }}kg</div>
        </div>
        <div class="list">
    ...
    <div class="item">
      <div class="header">
        <div class="title">
          <i class="iconfont iconshebeii"></i>
          <span>设备信息</span>
        </div>
      </div>
      <div class="content lx_flex">
        <div class="leftCon">
          <div class="list">
    ...
    <div class="item">
      <div class="header">
        <div class="title">
          <i class="iconfont icontishifill"></i>
          <span>心率预警</span>
        </div>
      </div>
      <div class="content">
    ...
    <el-button type="primary" style="margin-top: 20px">导出设备数据<i class="el-icon-download el-icon--right"></i></el-button>
  </div>
</template>
